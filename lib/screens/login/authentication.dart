...
class AuthenticationPageState extends State<AuthenticationLoginScreen> {
  String otp = '';
  ...
  Future<String?> registerProvider() async {
    ...
    final url = Uri.parse('${dotenv.env['HOST']}/provider/verify_otp');
  ...
  Future<void> resendOTP() async {
    ...
    final url = Uri.parse('${dotenv.env['HOST']}/provider/resend_login_otp');
